...
if save and load:
    ...
    # remove all keys that are not metropolitan
    for station in station_objs:
        station_obj = station_objs[station]
        station_obj.platforms = [platform for platform in station_obj.platforms if platform.line in ["metropolitan", "circle_hammersmith-city_metropolitan", "circle_metropolitan_hammersmith-city", "metropolitan_circle_hammersmith-city", "circle_metropolitan", "metropolitan_piccadilly", "metro"]]
else:
    station_objs = {}
    get_timetables()
