...
def eval_genomes_threaded(genome, config, winner=0):
    ...
    starting_station_name = "Brixton"
    total_visited = 1
    new_station = station_objs[starting_station_name]
    # initiate clock
    start_time = dt.time(5, 26)
...
def run(config_path):
    ...
    # config.reproduction_config.min_species_size = config.pop_size // 2
    # print(config.reproduction_config.min_species_size)
    # sys.exit(0)
