...
def time_to_next_train(station, time, current_direction, current_line):
    ...
    for platform in station.platforms:
        ...
        # except TypeError:
        #     print(station, platform.departure_times, time)
        #     import sys
        #     sys.exit()
...
def change_line_or_direction_penalty(current_direction, current_line, platform):
    ...
    if platform.station == "Edgware Road (Circle)":
    ...
    # different_line = not((current_line.lower() in platform.line.lower()) and (platform.line.lower() in current_line.lower()))
    if different_line:
